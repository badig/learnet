...
if (mediaQuery.matches) {
    ...
    document.getElementById("modeln").appendChild(renderer.domElement);
    ...
    loader.load('../modeli/napajanje/scene.gltf', function(gltf){
        model = gltf.scene;
    ...
    window.onresize = function(){
        camera.aspect = window.innerWidth * width / window.innerHeight * width;
        camera.updateProjectionMatrix();

        renderer.setSize(window.innerWidth * width , window.innerHeight * width);
    }
