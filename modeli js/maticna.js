...
if (mediaQuery.matches) {
    ...
    document.getElementById("modelmp").appendChild(renderer.domElement);
    ...
    loader.load('../modeli/maticna/scene.gltf', function(gltf){
        model = gltf.scene;
    ...
    const tween = new TWEEN.Tween(scene.rotation).to({ y: -(30 * Math.PI / 180)}, 0).delay(0);
